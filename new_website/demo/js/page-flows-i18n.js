...
i18n.init({
    en: {
        ...
        pf: {
            ...
            changeModel: 'change', toolsLabel: 'Tools', retest: 'retest',
            toolAvail: 'available', toolUnavail: 'unavailable', toolTesting: 'testing...',
            toolPass: 'pass', toolFail: 'fail', mock: 'mock',
    ...
    zh: {
        ...
        pf: {
            ...
            dropContent: '+ 添加 .md, .txt, .json', dropTemplate: '+ 添加 .html', dropStyle: '+ 添加 .css, .md, .txt',
            ...
            changeModel: '更换', toolsLabel: '工具', retest: '重新检测',
            toolAvail: '可用', toolUnavail: '不可用', toolTesting: '检测中...',
            toolPass: '通过', toolFail: '失败', mock: '模拟',
