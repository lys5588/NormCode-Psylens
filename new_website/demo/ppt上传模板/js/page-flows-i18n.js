/**
 * Page-Flows i18n — PPT Template variant
 *
 * Steps:
 *   0  Connection
 *   1  Basic Inputs
 *   2  PPT Template      ← new (was HTML Templates)
 *   3  Content Files     ← moved from step 2
 *   4  Style Guides
 *   5  Review & Launch
 *   6  Running
 */
...
i18n.init({
    en: {
        ...
        pf: {
            ...
            s2title: 'PPT Template',    s2sub: 'Upload the PPTX slide template to use.',
            s3title: 'Content Files',   s3sub: 'Add content reference files (optional).',
            s4title: 'Style Guides',    s4sub: 'Add text style guides (optional).',
            ...
            refTemplate: 'PPT Template',  dropTemplate: '+ Upload .pptx',
            refContent:  'Content Files', dropContent:  '+ Add .md, .txt, .json, .pdf, .docx, .pptx, .xlsx',
            refStyle:    'Style Guides',  dropStyle:    '+ Add .md, .txt',

            templateReplace: 'A template is already selected — uploading will replace it.',
            ...
            convertProceed: 'Convert & Add', convertCancel: 'Cancel',

            reviewTopic: 'Topic', reviewAudience: 'Audience', reviewLength: 'Length',
            reviewTemplate: 'PPT Template', reviewContent: 'Content refs', reviewStyle: 'Style guides', reviewModel: 'Model',
            nFiles: ' file(s)', templateNone: '(none)',

            launch: 'Launch', uploading: 'Uploading files...', starting: 'Starting run...',
            launchFailed: 'Launch failed: ',

            runSub: 'Generating your presentation...', runWaiting: 'Waiting...',
    ...
    zh: {
        ...
        pf: {
            ...
            s2title: 'PPT 模板',   s2sub: '上传要使用的 PPTX 幻灯片模板。',
            s3title: '内容文件',    s3sub: '添加内容参考文件（可选）。',
            s4title: '样式指南',    s4sub: '添加文字样式指南（可选）。',
            ...
            refTemplate: 'PPT 模板',  dropTemplate: '+ 上传 .pptx',
            refContent:  '内容文件',  dropContent:  '+ 添加 .md, .txt, .json, .pdf, .docx, .pptx, .xlsx',
            refStyle:    '样式指南',  dropStyle:    '+ 添加 .md, .txt',

            templateReplace: '已选择模板 — 重新上传将替换当前模板。',

            convertTitle: '转换为纯文本？',
            convertMsg: '这些文件将被转换为纯文本。格式、图片、图表和布局将会丢失，仅提取文本内容作为参考材料。',
            convertProceed: '转换并添加', convertCancel: '取消',

            reviewTopic: '主题', reviewAudience: '受众', reviewLength: '长度',
            reviewTemplate: 'PPT 模板', reviewContent: '内容引用', reviewStyle: '样式指南', reviewModel: '模型',
            nFiles: ' 个文件', templateNone: '（未选择）',

            launch: '启动生成', uploading: '正在上传文件...', starting: '正在启动运行...',
            launchFailed: '启动失败：',

            runSub: '正在生成演示文稿...', runWaiting: '等待中...',
...
function t(key) {
    ...
    const en = {
        ...
        nFiles: ' file(s)', templateNone: '(none)',
        templateReplace: 'A template is already selected — uploading will replace it.',
        templateRequired: 'A PPT template (.pptx) is required before continuing.',
        launch: 'Launch', relaunch: 'Re-launch', uploading: 'Uploading files...', starting: 'Starting run...', launchFailed: 'Launch failed: ',
        runStarted: 'Run started: ', runCompleted: 'Completed!', runCompletedSub: 'Generation finished successfully.',
        runFailed: 'Failed: ', inferences: ' inferences',
        preview: 'Preview', previewFailed: 'Preview failed: ',
        changeModel: 'change', mock: 'mock',
    ...
    const zh = {
        ...
        nFiles: ' 个文件', templateNone: '（未选择）',
        templateReplace: '已选择模板 — 重新上传将替换当前模板。',
        templateRequired: '请先上传 PPT 模板文件（.pptx）再继续。',
        launch: '启动生成', relaunch: '重新启动', uploading: '正在上传文件...', starting: '正在启动运行...', launchFailed: '启动失败：',
        runStarted: '运行已启动：', runCompleted: '已完成！', runCompletedSub: '生成已成功完成。',
        runFailed: '失败：', inferences: ' 次推理',
        preview: '预览', previewFailed: '预览失败：',
        changeModel: '更换', mock: '模拟',
